...
STEP 4: Now execute sql query in same terminal
...
Step 1: Click On File > Import > Git > Projects From Git > Clone Uri  > Paste The Repository Url: ```https://github.com/Saptak2002/Train-Ticket-Reservation-System.git``` > Next > Select Master Branch > Next > Finish
